    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-blue-600 flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white shadow-md">
        <div className="flex items-center gap-4">
          <Image src="/imagenes/logo/logo-icai.jpeg" alt="Logo ICAI" width={60} height={60} className="rounded bg-white" />
          <span className="text-2xl font-bold text-[#023474] tracking-wide">ICAI</span>
        </div>
        <Link href="/auth/login">
          <button className="bg-[#023474] text-white px-6 py-2 rounded-lg shadow hover:bg-blue-800 font-semibold text-lg transition">AULA VIRTUAL</button>
        </Link>
      </header>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between flex-1 px-8 py-12 gap-8">
        <div className="max-w-xl">
          ...
          <Link href="/auth/login">
            <button className="bg-white text-[#023474] px-8 py-3 rounded-lg shadow-lg hover:bg-blue-100 font-bold text-xl transition">AULA VIRTUAL</button>
          </Link>
        </div>
      ...
      <footer className="bg-white py-8 px-4 border-t mt-8">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col gap-2 text-[#023474]">
            <span className="font-bold text-lg">Enlaces útiles</span>
            <Link href="/auth/login" className="hover:underline">AULA VIRTUAL</Link>
            <Link href="/verificar-certificado" className="hover:underline">Verificar Certificación</Link>
          </div>
        </div>
